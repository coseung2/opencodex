...
export type StoredCodexPoolAuthContext = Extract<CodexAuthContext, { kind: "pool" | "main-pool" }>;
export type ForwardCodexPoolAuthContext = Exclude<CodexAuthContext, { kind: "main" }>;

export function isStoredCodexPoolAuthContext(
