...
/**
 * Frame-aware output boundary for native Responses streams. Complete SSE
 * blocks are forwarded through the first protocol terminal; later bytes are
 * dropped so a provider-held HTTP connection cannot keep the client waiting.
 */
