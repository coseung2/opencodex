...
usage подтверждает исчерпание квоты: opencodex сохраняет его приостановленным в состоянии ожидания
прогрева и автоматически повторяет прогрев после указанного времени сброса. Ошибки аутентификации
и другие ошибки прогрева по-прежнему отклоняют добавление аккаунта.
