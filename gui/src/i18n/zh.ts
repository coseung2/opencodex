...
export const zh: Record<TKey, string> = {
  ...
  "api.key.roleLabel": "API 密钥角色",
  "api.key.roleUser": "仅 API",
  "api.key.roleViewer": "查看者",
  "api.key.roleOperator": "操作员",
  "api.key.roleAdmin": "管理员",
  "api.generate": "生成",
  "api.generating": "创建中…",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.addAccount": "添加账户",
  "kiroLogin.title": "添加 Kiro 账户",
  "kiroLogin.description": "选择此附加 Kiro 账户的登录方式。",
  "kiroLogin.accountType": "Kiro 账户类型",
  "kiroLogin.personal": "个人账户",
  "kiroLogin.personalDescription": "使用个人 AWS Builder ID 登录。",
  "kiroLogin.organization": "组织账户",
  "kiroLogin.organizationDescription": "通过组织的 IAM Identity Center 登录。",
  "kiroLogin.startUrl": "开始 URL",
  "kiroLogin.startUrlPlaceholder": "https://example.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "请输入规范的 awsapps.com/start URL。",
  "kiroLogin.region": "区域",
  "kiroLogin.regionPlaceholder": "ap-southeast-1",
  "kiroLogin.continue": "继续",
  ...
  "pws.capacity.estimate": "加权账户池估算",
  "pws.capacity.coverage": "{included}/{total} 个账户",
  "pws.capacity.nextRecovery": "下次恢复 {time}",
