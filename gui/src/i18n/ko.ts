...
export const ko: Record<TKey, string> = {
  ...
  "api.key.roleLabel": "API 키 권한",
  "api.key.roleUser": "API 사용만",
  "api.key.roleViewer": "조회자",
  "api.key.roleOperator": "운영자",
  "api.key.roleAdmin": "관리자",
  "api.generate": "생성",
  "api.generating": "생성 중…",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "kiroLogin.title": "Kiro 계정 추가",
  "kiroLogin.description": "추가할 Kiro 계정의 로그인 방식을 선택하세요.",
  "kiroLogin.accountType": "Kiro 계정 유형",
  "kiroLogin.personal": "개인 계정",
  "kiroLogin.personalDescription": "개인 AWS Builder ID로 로그인합니다.",
  "kiroLogin.organization": "조직 계정",
  "kiroLogin.organizationDescription": "조직의 IAM Identity Center를 통해 로그인합니다.",
  "kiroLogin.startUrl": "시작 URL",
  "kiroLogin.startUrlPlaceholder": "https://example.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "올바른 awsapps.com/start URL을 입력하세요.",
  "kiroLogin.region": "리전",
  "kiroLogin.regionPlaceholder": "ap-northeast-2",
  "kiroLogin.continue": "계속",
  "pws.addKey": "API 키 추가",
  "pws.apiKeys": "API 키",
  "pws.authMode": "인증 방식",
  ...
  "pws.capacity.estimate": "가중 풀 추정치",
  "pws.capacity.coverage": "계정 {included}/{total}",
  "pws.capacity.nextRecovery": "다음 회복 {time}",
