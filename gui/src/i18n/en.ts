...
export const en = {
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "kiroLogin.title": "Add Kiro account",
  "kiroLogin.description": "Choose how this additional Kiro account signs in.",
  "kiroLogin.accountType": "Kiro account type",
  "kiroLogin.personal": "Personal account",
  "kiroLogin.personalDescription": "Sign in with a personal AWS Builder ID.",
  "kiroLogin.organization": "Organization account",
  "kiroLogin.organizationDescription": "Sign in through your organization’s IAM Identity Center.",
  "kiroLogin.startUrl": "Start URL",
  "kiroLogin.startUrlPlaceholder": "https://example.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "Enter your canonical awsapps.com/start URL.",
  "kiroLogin.region": "Region",
  "kiroLogin.regionPlaceholder": "us-east-1",
  "kiroLogin.continue": "Continue",
  ...
  "pws.capacity.estimate": "Weighted pool estimate",
  "pws.capacity.coverage": "{included}/{total} accounts",
  "pws.capacity.nextRecovery": "next recovery {time}",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "api.key.roleLabel": "API key role",
  "api.key.roleUser": "API only",
  "api.key.roleViewer": "Viewer",
  "api.key.roleOperator": "Operator",
  "api.key.roleAdmin": "Admin",
