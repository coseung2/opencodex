...
export const de: Record<TKey, string> = {
  ...
  "api.key.roleLabel": "API-Schlüsselrolle",
  "api.key.roleUser": "Nur API",
  "api.key.roleViewer": "Betrachter",
  "api.key.roleOperator": "Operator",
  "api.key.roleAdmin": "Administrator",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "kiroLogin.title": "Kiro-Konto hinzufügen",
  "kiroLogin.description": "Wähle aus, wie sich dieses zusätzliche Kiro-Konto anmeldet.",
  "kiroLogin.accountType": "Kiro-Kontotyp",
  "kiroLogin.personal": "Persönliches Konto",
  "kiroLogin.personalDescription": "Mit einer persönlichen AWS Builder ID anmelden.",
  "kiroLogin.organization": "Organisationskonto",
  "kiroLogin.organizationDescription": "Über das IAM Identity Center deiner Organisation anmelden.",
  "kiroLogin.startUrl": "Start-URL",
  "kiroLogin.startUrlPlaceholder": "https://beispiel.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "Gib deine kanonische awsapps.com/start-URL ein.",
  "kiroLogin.region": "Region",
  "kiroLogin.regionPlaceholder": "eu-central-1",
  "kiroLogin.continue": "Weiter",
  ...
  "pws.capacity.estimate": "Gewichtete Pool-Schätzung",
  "pws.capacity.coverage": "{included}/{total} Konten",
  "pws.capacity.nextRecovery": "nächste Erholung {time}",
