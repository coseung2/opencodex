...
export const ru: Record<TKey, string> = {
  ...
  "kiroLogin.title": "Добавить аккаунт Kiro",
  "kiroLogin.description": "Выберите способ входа для дополнительного аккаунта Kiro.",
  "kiroLogin.accountType": "Тип аккаунта Kiro",
  "kiroLogin.personal": "Личный аккаунт",
  "kiroLogin.personalDescription": "Войти с личным AWS Builder ID.",
  "kiroLogin.organization": "Аккаунт организации",
  "kiroLogin.organizationDescription": "Войти через IAM Identity Center вашей организации.",
  "kiroLogin.startUrl": "Начальный URL",
  "kiroLogin.startUrlPlaceholder": "https://example.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "Введите канонический URL awsapps.com/start.",
  "kiroLogin.region": "Регион",
  "kiroLogin.regionPlaceholder": "eu-central-1",
  "kiroLogin.continue": "Продолжить",
  ...
  "pws.capacity.estimate": "Взвешенная оценка пула",
  "pws.capacity.coverage": "{included}/{total} аккаунтов",
  "pws.capacity.nextRecovery": "следующее восстановление {time}",
  ...
  "api.key.roleLabel": "Роль API-ключа",
  "api.key.roleUser": "Только API",
  "api.key.roleViewer": "Наблюдатель",
  "api.key.roleOperator": "Оператор",
  "api.key.roleAdmin": "Администратор",
