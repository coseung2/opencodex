...
export const ja: Record<TKey, string> = {
  ...
  "kiroLogin.title": "Kiro アカウントを追加",
  "kiroLogin.description": "追加する Kiro アカウントのログイン方法を選択してください。",
  "kiroLogin.accountType": "Kiro アカウントの種類",
  "kiroLogin.personal": "個人アカウント",
  "kiroLogin.personalDescription": "個人の AWS Builder ID でログインします。",
  "kiroLogin.organization": "組織アカウント",
  "kiroLogin.organizationDescription": "組織の IAM Identity Center からログインします。",
  "kiroLogin.startUrl": "開始 URL",
  "kiroLogin.startUrlPlaceholder": "https://example.awsapps.com/start",
  "kiroLogin.startUrlInvalid": "正規の awsapps.com/start URL を入力してください。",
  "kiroLogin.region": "リージョン",
  "kiroLogin.regionPlaceholder": "ap-northeast-1",
  "kiroLogin.continue": "続行",
  ...
  "pws.capacity.estimate": "重み付きプール推定",
  "pws.capacity.coverage": "{included}/{total} アカウント",
  "pws.capacity.nextRecovery": "次の回復 {time}",
  ...
  "api.key.roleLabel": "APIキーの権限",
  "api.key.roleUser": "APIのみ",
  "api.key.roleViewer": "閲覧者",
  "api.key.roleOperator": "運用者",
  "api.key.roleAdmin": "管理者",
  "api.generate": "生成",
  "api.generating": "作成中…",
